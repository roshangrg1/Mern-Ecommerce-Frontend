...
function OrderSuccessPage(){
    ...
    const params = useParams()  // react router provides this hook
    ...
    return (
        ...
        <div className="text-center">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">OrderNumber #{params?.id}</h1>
