...
import { deleteItemsFromCartAsync, updateCartAsync, selectItems, } from "../features/cart/CartSlice";
...
const CheckoutPage = () => {
  ...
  const handleOrder = (e)=>{
    const order = {items, totalAmount, totalItems, user, payementMethod, selectedAddress}
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5 ">
        <div className="lg:col-span-3">
          <form className="bg-white mt-12" noValidate onSubmit={handleSubmit((data) => {
              console.log(data);
            ...
            <div className="space-y-12 text-left">
              <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-2xl pt-2 font-semibold leading-7 text-gray-900  ">
